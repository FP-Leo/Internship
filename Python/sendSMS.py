...
# Modifications include sending a custom SMS with twilio when the script gets triggered.
...
def main(argv):
    ...
    if msg.command == ADD_COMMAND:
        ...
        bodyMessage = "Message: " + alert["data"]["win"]["system"]["message"] + "\n" + "Agent ID, name, IP: " + \
                      alert["agent"]["id"] + ", " + alert["agent"]["name"] + ", " + alert["agent"][
                          "ip"] + "\n" + "Provider name: " + alert["data"]["win"]["system"][
                          "providerName"] + "\nComputer: " + alert["data"]["win"]["system"][
                          "computer"] + "\nSystem Time: " + alert["data"]["win"]["system"]["systemTime"]
        sendSMS(bodyMessage)
